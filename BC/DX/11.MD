...
Typ|Min. bitů|Poznámka / Min.rozsah
:--|--:|:--
`char`|8|Typicky použit pro uchování jednoho znaku. Není specifikováno, zdali je un/signed.
`signed char`|8|Char, kde je zaručeno, že bude znaménkový. [-127&emsp;+127]
`unsigned char`|8|Char, kde je zaručeno, že bude bezznaménkový. [0&emsp;255]
`short`|16|[-32 767&emsp;+32 767]
`unsigned short`|16|[0&emsp;65 535]
`int`|16|[-32 767&emsp;+32 767]
`unsigned int`|16|[0&emsp;65 535]
`long`|32|[−2 147 483 647&emsp;+2 147 483 647]
`unsigned long`|32|[0&emsp;4 294 967 295]
`float`||Obvykle IEEE 754 single (32 bit).
`double`||Obvykle IEEE 754 double (64 bit).
`long double`||Může být extended (80 bit) nebo quadruple (128 bit).
