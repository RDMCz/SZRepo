...
Typ|Min. bitů|Poznámka|Minimální rozsah
:--|--:|:--|--:
`char`|8|Typicky použit pro uchování jednoho znaku. Není specifikováno, zdali je un/signed.|—
`signed char`|8|Char, kde je zaručeno, že bude znaménkový.      |[-127 až +127]
`unsigned char`|8|Char, kde je zaručeno, že bude bezznaménkový. |[0 až +255]
