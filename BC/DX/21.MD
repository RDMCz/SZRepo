...
* Spanning Tree Protocol (~odstraňuje smyčky vzniklé redundantními spoji)
...
| 2006 | 802.3an |                     |               | UTP         |
+------+---------+---------------------+---------------+-------------+
|     dále 40, 100, 200, 400, 800 GbE >= 40 000 Mbit/s               |
+--------------------------------------------------------------------+
```
...
* Pravidelně (defaultně zhruba stokrát za sekundu) vysílá beacon frame s informacemi o síti a pro synchronizaci času
...
### Fyzická vrstva bezdrátových sítí
...
* RTS/CTS jsou krátké rámce – malá šance na kolizi
...
<img alt="NAV" src="./MG/21_03.png" width="666" />

* Pokud jsou data krátká, tak jsou odeslána rovnou
...
<img alt="Wireless rámec" src="./MG/21_04.png" width="800" />
...
* Viz [wikimedia/802.1XWiredProtocols](https://upload.wikimedia.org/wikipedia/commons/1/1f/802.1X_wired_protocols.png), ([archived](https://web.archive.org/web/20250822001640/https://upload.wikimedia.org/wikipedia/commons/1/1f/802.1X_wired_protocols.png))
...
* __WPA__ bylo zavedeno jako přechodné řešení, které implementuje některé prvky standardu (TKIP)
