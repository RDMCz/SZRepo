...
* Příklad časově nezávislého systému: _y_(_t_)=_kx_(_t_) nebo _y_(_t_)=_x_(_t_ - 2)
* Příklad časově závislého systému: _y_(_t_)=_<b>t</b>x_(_t_) nebo _y_(_t_)=_x_(_t_ __⋅__ 2)
