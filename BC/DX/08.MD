...
* Uchování v souboru s určitým formátem a kontejnerem, např.:
  * Bez komprese – obvykle WAV; jedná se však pouze o kontejner, do kterého lze uložit i&nbsp;komprimovaná data
  * Lossless (bezztrátová komprese) – FLAC
  * Lossy (ztrátová komprese) – MP3
