...
* Nespojované služby
  ...
  * Pozn.: Pakety této služby bývají označovány jako _datagramy_, i když se nutně nemusí jednat o UDP
...
* Délka 4 bajty; zápis v desítkové soustavě, jednotlivé bajty oddělneé tečkou
...
* __Autonomní systém (AS)__ – část internetu se společnou směrovací politikou (ISP + zákazníci)
* __Interior Gateway Protocol__ – směrování uvnitř AS, důraz na rychlost (RIP, OSFP)
...
* Pokud je datagram větší než MTU (Maximum Transmission Unit, různá pro zůzné fyzické sítě), pak je rozdělen na fragmenty
...
* Potvrzovací číslo _ack_ – Následující pořadové číslo, které je očekáváno; zároveň potvrzuje příjem všech předchozích dat [4 B]
...
* Kořenové servery
  ...
  * 13 logical root name serverů, realizovány více stroji (+ distribuováno po světě s využitím anycast)
...
* __Nerekurzivní zpracování__
  * Server odpovíd odkazem, kde hledat dál
