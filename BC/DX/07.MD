...
<img alt="$x(t)\to X(f)=\int_{-\infty}^{\infty}\!x(t)\cdot e^{-ift}\,\mathrm{d}t$" src=".\MG\LX\07_s01.svg">
...
<img alt="$x[n]\to X[k]=\frac{1}{N}\sum_{n=0}^{N-1}x[n]\cdot e^{\frac{-i2\pi kn}{N}}$" src=".\MG\LX\07_s03.svg">
