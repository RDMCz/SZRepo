...
Matice záměn je 2×2 kontingenční tabulka zobrazující true/false positive/negative.
...
Křivka ROC ukazuje kvalitu binárního klasifikátoru pro různé hodnoty nastavení jeho prahu. Osa Y je TPR (sensitivita) a osa X je FPR. Alternativně se na ose X může použít přesnost (v určitých případech vede na zajímavější výsledky).
