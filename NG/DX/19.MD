...
* Při řešení problému není vždy nutné implementovat nějaký NV do posledního detailu, vždy je důležité myslet v kontextu našeho projektu
...
* State je návrhový vzor chování
...
* Může být zbytečně složité, pokud máme malý počet stavů a skoro mezi nimi nepřepínáme

### Strategy (strategie)

* Strategy je návrhový vzor chování
...
* Tento vzor ztrácí význam v hodně moderních jazycích, které podporují funkce vyššího řádu

<img alt="UML strategy" src="./MG/19_02.svg" />

### Observer (pozorovatel)

* Observer je návrhový vzor chování
...
* Composite je strukturální návrhový vzor
