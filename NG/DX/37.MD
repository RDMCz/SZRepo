...
<!--* Synchronizace:
  * Synchronní – vhodné pro velké objemy dat, konstantní přenosová rychlost; způsoby synchronizace:
    1. Extra drát s hodinami, nepoužitelné pro delší spoje
    2. Přijímač i vysílač mají vlastní hodiny a musí se synchronizovat pomocí pulzů vysílaných společně s daty
    3. Fázová či frekvenční modulace
...
Sběrnice mohou být dlouhá vedení, která je třeba impedančně zakončit terminátory, aby nedocházelo vlivem odrazů k interferencím.
-->
