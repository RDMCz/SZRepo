...
* V OpenGL:
  * Surová data vertexů (např. souřadnice + normály + texturovací souřadnice) vkládáme do VBO (_Vertex Buffer Object_)
  * Abychom neopakovali stejná data, můžeme využít EBO (_Element Buffer Object_), který obsahuje indexy vertexů z VBO
  * Pomocí VAO (_Vertex Array Object_) popíšeme, v jakém formátu jsou surová data vertexů
