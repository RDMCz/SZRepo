...
* Jakmile máme hotový strom:
  ...
  * Vstupní (startovní) stav je kořen
  * Pokud množina uzlu obsahuje alespoň jeden původní výstupní stav, pak je stav, který množina reprezentuje, označen za výstupní (koncový)
...
* Stejné jako sjednocení, ale výstupní stavy jsou pouze ty, kde jsou všechny původní stavy v množině uzlu výstupní
