...
* __Kódová abeceda__ 𝐵 = {𝑏₁, ..., 𝑏<sub>𝑛</sub>} a její prvky zvané kódové znaky
  ...
  * Pokud máme 𝑛-znakový kód, dokážeme vytvořit 𝑛<sup>𝑑</sup> slov o délce 𝑑
* __Kódování__
...
* __Kódování zdrojových zpráv__
  * Je-li __prosté__ zobrazení 𝐾: 𝐴 → 𝐵<sup>\*</sup> kódování, potom:
    ...
    * To, že 𝐾 je prosté, nutně neznamená, že 𝐾<sup>\*</sup> je prosté
...
![$$\begin{align*}n^{-d_1}+n^{-d_2}+…+n^{-d_r}&\le1\\\\\sum_{i=1}^rn^{-d_i}&\le1\end{align*}$$](./MG/LX/06-1aafbab864.svg)
...
Nejkratší 𝑛-znakový kód zdrojové abecedy je takový 𝑛-znakový prefixový kód dané abecedy, který má ze všech 𝑛-znakových prefixových kódů dané abecedy nejmenší střední délku kódového slova. Existuje vždy, ale není určen jednoznačně (může jich pro danou abecedu existovat více).
