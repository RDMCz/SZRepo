...
* __Cookie__: Speciální HTTP hlavičky pro předávání parametrů mezi klientem a serverem
  ...
  * Cookie lze používat pouze pro identifikaci uživatele, samotná data jsou pak uložena serveru
...
* Někdy bývá nazývána jako _třívrstvá architektura_, kdy třetí vrstvou je databáze (prezentace ↔ logika ↔ data)
