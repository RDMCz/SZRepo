...
* __Cookie__: Speciální HTTP hlavičky pro předávání parametrů mezi klientem a serverem
  ...
  * Cookies lze také používat pouze pro identifikaci uživatele a příslušná data mít uložena serveru
...
* Někdy bývá nazývána jako _třívrstvá architektura_, kde třetí vrstvou je databáze (prezentace ↔ logika ↔ data)
