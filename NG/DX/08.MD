...
* Jeden blok převede 128bitový plaintext na 128bitový ciphertext (16 bajtů)
  * Blok je po bajtech rozdělen na čtverec 4x4, jednotlivé buňky nazýváme stavy S₀ – S₁₅, číslováno po sloupcích
...
[SR]             |    |            * 4KB veřejně známých tabulek nezávislých na klíči
[MC]             |    |          [SR] – Shift Rows
...
* Zprávu je potřeba doplnit na délku dělitelnou 16 bajty
  ...
  * Nebo se na doplnění 𝑍<sub>𝑛</sub> použije část bitů z 𝐶<sub>𝑛-1</sub> (metoda _ciphertext steling_)
...
* Narozeninový útok „využívá“ narozeninového paradoxu
  ...
  * S přibývajícími vypočtenými hashi opět stoupá počet provnávání a tedy šance na kolizi
...
* Soukromý klíč: trojice čísel (𝑝₁, 𝑝₂, 𝑑)
...
* Platí:
  * ϕ(𝑛) = (𝑝₁ - 1)(𝑝₂ - 1) &emsp; (Eulerova funkce)
  * NSD(𝑒, ϕ(𝑛)) = 1
  * 𝑒 ⋅ 𝑑 ≡ 1 (mod ϕ(𝑛)) → odsud je odvozen soukromý exponent 𝑑
* Šifrování:
  * 𝐶 = 𝑍<sup>𝑒</sup> mod 𝑛
* Dešifrování:
  * 𝑍 = 𝐶<sup>𝑑</sup> mod 𝑛<br>&emsp;= (𝑍<sup>𝑒</sup>)<sup>𝑑</sup> mod 𝑛<br>&emsp;= 𝑍<sup>𝑒𝑑</sup> mod 𝑛 &emsp; (Eulerova věta↴)<br>&emsp;= 𝑍 mod 𝑛
