...
* __Konfuze__
  * Vstup (𝑍 + 𝐾ᴱ) je prohnán komplexními transformacemi
  * → Každý bit 𝐶 by měl záviset na více bitech klíče
  * Využití substitucí
* __Difuze__
  * Transformace vstupu jsou rovnoměrně závislé na všech bitech vstupu
  * → Každý bit 𝑍 by měl ovlivňovat co nejvíce bitů 𝐶
  * Využití permutací
