...
* Výhoda:
  * Oproti Harvard flexibilnější (nevadí velký program + malá data a naopak)
...
* Binární tvar: _opcode_ + _operandy_; obvykle zapisujeme v jazyce symbolických adres (_assembly language_)
...
* Registry jsou rychlejší než jakákoliv paměť, umožňují náhodný přístup, snadnou implementaci paralelismu, vedou na méně časté sahání do paměti (zrychlení)
