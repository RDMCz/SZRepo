...
* __SOAP – Simple Object Access Protocol__
...
* __WSDL – Web Services Description Language__
  * Popis veřejného rozhraní webové služby, definuje dostupné funkce a povolené hodnoty parametrů
* __UDDI – Universal Description, Discovery and Integration__
...
Strojově čitelná data musí být strukturovaná. Lze je rozdělit do dvou skupin: Člověkem čitelná data _označkovaná_ tak, aby je mohl přečíst i stroj (HTML, [Mikroformát](https://en.wikipedia.org/wiki/Microformat#Examples), RDFa), a data ve formátu určeném primárně ke strojovému zpracování (CSV, RDF, XML, JSON, ...). Data považujeme za strojově čitelná, pokud splňují pravidla svého formátu.
